...
export default function SettingsScreen() {
  ...
  const handleClearData = () => {
    Alert.alert(
      'Clear All Data',
      'This will delete all folders and swatches. This cannot be undone.',
      [
    ...
    <ScrollView style={[styles.container, { paddingTop: insets.top }]} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingRow}>
          <View style={styles.settingInfo}>
            ...
            <Text style={styles.settingDescription}>
              Vibrate on color extraction
            </Text>
          </View>
          <Switch
            value={settings.hapticFeedback}
            onValueChange={() => handleToggle('hapticFeedback')}
            trackColor={{ false: colors.warmGray, true: colors.darkGrey }}
        ...
        <View style={styles.settingRow}>
          <View style={styles.settingInfo}>
            ...
            <Text style={styles.settingDescription}>
              Automatically save to last used folder
            </Text>
          </View>
          <Switch
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerSubtext}>
          Professional color extraction with accurate paint mixing
        </Text>
      </View>
    </ScrollView>
  );
